...
#if defined(USE_LINEAR_ACCEL) || defined(USE_TRAPEZOID_ACCEL) ||               \
    defined(USE_SMOOTHSTEP_ACCEL)
...
#error Please review the config.h file.
#else
#if !defined(NTC_NOMINAL_TEMP) || !defined(NTC_BCOEFFICIENT) ||                \
    !defined(NTC_NOMINAL_VAL) || !defined(NTC_RESISTOR_VAL)
